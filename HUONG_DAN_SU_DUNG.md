...
- **Thêm vào giỏ:** bấm _Thêm vào giỏ_; chỉnh số lượng hoặc xóa trong khu vực Giỏ hàng.
...
- **Theo dõi đơn:** mục _Lịch sử đơn hàng_ hiển thị trạng thái từng đơn (New → Confirmed → Shipping → Delivered…).
- **Xem chi tiết & đánh giá:** bấm _Chi tiết & Đánh giá_ ở thẻ sản phẩm (xem mục 5).
...
- Phải **đã mua** sản phẩm (đơn ở trạng thái _Delivered_ hoặc _Confirmed_).
...
- Xem tất cả đánh giá (kể cả đã ẩn), lọc theo _Đang hiển thị / Đã ẩn_.
...
5. Khi đơn _Delivered_, khách quay lại viết **đánh giá** sản phẩm.
6. Kế toán/Admin xem **báo cáo** doanh thu, lợi nhuận theo kênh.

**Trả hàng / hoàn tiền:** từ đơn hàng tạo phiếu trả hàng (lý do) → Warehouse/Admin duyệt → tồn kho hoàn lại, trạng thái chuyển _Returned_.
